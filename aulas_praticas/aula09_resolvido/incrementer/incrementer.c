...
/*
N threads vai dar entre o numero de itercoes e o n*n_iter
100 iter e 2 threads dá entre 100 e 200
100 iter e 3 threads dá entre 100 e 300
/*
    ...
    do {
        ...
        { 
          ...
          case 'h': printf (USAGE, basename(argv[0]));
                    return EXIT_SUCCESS;
          case -1:  break;//fez parsing a todas as opcoes chegou ao fim
